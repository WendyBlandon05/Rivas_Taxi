        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Tu servicio de transporte de confianza en la costa del Pacifico de Nicaragua. 
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-amber-400">Enlaces Rapidos</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-amber-400">Nuestros Servicios</h3>
            <ul className="space-y-2">
              <li className="text-gray-400 text-sm">Viajes Interdepartamentales</li>
              <li className="text-gray-400 text-sm">Servicio Turistico</li>
              <li className="text-gray-400 text-sm">Traslados Locales</li>
              <li className="text-gray-400 text-sm">Recogida Programada</li>
              <li className="text-gray-400 text-sm">Tours Privados</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">24/7 Disponible</span>
              </li>
            </ul>
            {/* WhatsApp Button */}
            <Link 
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              &copy; {new Date().getFullYear()} Pacific Coast Taxi. Todos los derechos reservados.
            </p>
