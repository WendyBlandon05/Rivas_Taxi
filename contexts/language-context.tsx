...
const dictionary: Dictionary = {
  ...
  "services.interdepartamental.title": { es: "VIAJES INTERDEPARTAMENTALES", en: "INTERCITY RIDES" },
  "services.interdepartamental.description": {
    es: "RESERVAS SEGURAS HACIA OTROS DESTINOS DE NICARAGUA.",
    en: "SAFE BOOKINGS TO OTHER DESTINATIONS IN NICARAGUA.",
  },
  "services.turistico.title": { es: "SERVICIO TURISTICO", en: "TOURIST SERVICE" },
  "services.turistico.description": {
    es: "TRASLADOS COMODOS HACIA PLAYAS, HOTELES Y DESTINOS TURISTICOS.",
    en: "COMFORTABLE RIDES TO BEACHES, HOTELS AND TOURIST DESTINATIONS.",
  },
  "services.local.title": { es: "TRASLADOS LOCALES", en: "LOCAL RIDES" },
  "services.local.description": {
    es: "MOVILIDAD RAPIDA DENTRO DE RIVAS CON ATENCION INMEDIATA.",
    en: "FAST MOBILITY WITHIN RIVAS WITH IMMEDIATE SUPPORT.",
  },
  "services.programada.title": { es: "RECOGIDA PROGRAMADA", en: "SCHEDULED PICKUP" },
  "services.programada.description": {
    es: "DESDE HOTELES, TERMINALES O UBICACION ACORDADA.",
    en: "FROM HOTELS, TERMINALS OR AN AGREED LOCATION.",
  },
  ...
  "booking.service.turistico.description": { es: "Tours y traslados a destinos turisticos", en: "Tours and transfers to tourist destinations" },
  "booking.service.interdepartamental.name": { es: "Viajes Interdepartamentales", en: "Intercity Rides" },
  "booking.service.interdepartamental.description": { es: "Traslados entre departamentos", en: "Transfers between departments" },
  "booking.service.local.name": { es: "Traslados Locales", en: "Local Rides" },
  "booking.service.local.description": { es: "Movilidad rapida dentro de Rivas", en: "Fast mobility within Rivas" },
  "booking.service.programada.name": { es: "Recogida Programada", en: "Scheduled Pickup" },
  "booking.service.programada.description": { es: "Recogida en hoteles, terminales o aeropuertos", en: "Pickup from hotels, terminals or airports" },
