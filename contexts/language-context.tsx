...
const dictionary: Dictionary = {
  ...
  "nav.review": { es: "Dejar Reseña", en: "Leave Review" },
  ...
  "hero.title3": { es: "PACÍFICO", en: "PACIFIC COAST" },
  "hero.title4": { es: "NICARAGUENSE", en: "OF NICARAGUA" },
  "hero.subtitle": {
    es: "RESERVAS RÁPIDAS, CONDUCTORES CONFIABLES Y ATENCIÓN INMEDIATA.",
  ...
  "services.subtitle": {
    es: "OPCIONES SEGURAS Y CÓMODAS PARA CLIENTES NACIONALES Y EXTRANJEROS.",
  ...
  "services.turistico.title": { es: "SERVICIO TURÍSTICO", en: "TOURIST SERVICE" },
  "services.turistico.description": {
    es: "RECORRIDOS A DESTINOS VACACIONALES DEL PACÍFICO NICARAGÜENSE.",
  ...
  "trips.bookedDescription": {
    es: "Tu viaje ha sido confirmado. Revisa los detalles a continuación.",
  ...
  "trips.guestDescription": {
    es: "Inicia sesión para reservar un nuevo viaje.",
    en: "Log in to book a new ride.",
  },
  "trips.checkingSession": { es: "Verificando tu sesión...", en: "Checking your session..." },
  "trips.loginRequiredTitle": { es: "Inicia sesión para reservar", en: "Log in to book" },
  "trips.loginRequiredDescription": {
    es: "Para tu mayor seguridad debes iniciar sesión o crear una cuenta antes de completar una reservación.",
    en: "For your safety, please log in or create an account before completing a booking.",
  },
  "trips.login": { es: "Iniciar sesión", en: "Log in" },
  ...
  "booking.formTitle": { es: "Formulario de Reservación", en: "Booking Form" },
  ...
  "booking.personalInfo": { es: "Información Personal", en: "Personal Information" },
  ...
  "booking.originPlaceholder": { es: "Selecciona tu ubicación de recogida...", en: "Select your pickup location..." },
  ...
  "booking.coupon": { es: "Cupón de Descuento", en: "Discount Coupon" },
  ...
  "booking.couponPlaceholder": { es: "Ingresa tu código de cupón", en: "Enter your coupon code" },
  ...
  "booking.confirm": { es: "Confirmar Reservación", en: "Confirm Booking" },
  "booking.terms": {
    es: "Al confirmar, aceptas nuestros términos y condiciones de servicio.",
  ...
  "booking.service.turistico.name": { es: "Servicio Turístico", en: "Tourist Service" },
  "booking.service.turistico.description": { es: "Recorridos a destinos vacacionales y turísticos", en: "Trips to vacation and tourist destinations" },
  ...
  "booking.nameNoNumbers": { es: "El nombre no puede contener números", en: "Name cannot contain numbers" },
  ...
  "booking.phoneRequired": { es: "El teléfono es obligatorio", en: "Phone number is required" },
  "booking.phoneMissing": { es: "Faltan", en: "Missing" },
  "booking.phoneExtra": { es: "Sobran", en: "Extra" },
  "booking.digits": { es: "dígitos", en: "digits" },
  ...
  "booking.searchAddress": { es: "Buscar dirección...", en: "Search address..." },
  "booking.noGeolocation": { es: "Tu navegador no soporta geolocalización", en: "Your browser does not support geolocation" },
  "booking.locationError": {
    es: "No se pudo obtener tu ubicación. Por favor selecciona manualmente en el mapa.",
    en: "Could not get your location. Please select it manually on the map.",
  },
  "booking.gettingLocation": { es: "Obteniendo ubicación...", en: "Getting location..." },
  "booking.useCurrentLocation": { es: "Usar mi ubicación actual", en: "Use my current location" },
  "booking.mapInstructions": {
    es: "Haz clic en el mapa para seleccionar la ubicación",
    en: "Click on the map to select the location",
  },
  "booking.selectedLocation": { es: "Ubicación seleccionada:", en: "Selected location:" },
  "booking.cancel": { es: "Cancelar", en: "Cancel" },
  "booking.confirmLocation": { es: "Confirmar ubicación", en: "Confirm location" },
  ...
  "footer.description": {
    es: "Tu servicio de transporte de confianza en la costa del Pacífico de Nicaragua. Viaja seguro con nosotros.",
  ...
  "footer.pacificCoast": { es: "Costa del Pacífico", en: "Pacific Coast" },
  "footer.available": { es: "24/7 Disponible", en: "Available 24/7" },
  "footer.whatsapp": { es: "Escríbenos", en: "Message Us" },
